...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('djero_category', (
            ...
            ('collapsible', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('require_logged_in', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('djero', ['Category'])

        # Adding M2M table for field groups on 'Category'
        db.create_table('djero_category_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm['djero.category'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('djero_category_groups', ['category_id', 'group_id'])

        # Adding model 'Forum'
        db.create_table('djero_forum', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djero.Category'])),
            ...
            ('topic_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('message_count', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('activate', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('djero', ['Forum'])

        # Adding M2M table for field groups on 'Forum'
        db.create_table('djero_forum_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('forum', models.ForeignKey(orm['djero.forum'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('djero_forum_groups', ['forum_id', 'group_id'])

        # Adding model 'Moderator'
        db.create_table('djero_moderator', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('forum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djero.Forum'])),
        ))
        db.send_create_signal('djero', ['Moderator'])

        # Adding model 'Topic'
        db.create_table('djero_topic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djero.Category'], null=True, blank=True)),
            ('forum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djero.Forum'])),
            ...
            ('last_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_user', to=orm['auth.User'])),
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='message', null=True, to=orm['djero.Message'])),
            ('last_message', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='last_message', null=True, to=orm['djero.Message'])),
            ...
            ('active', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('responded_to', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('djero', ['Topic'])

        # Adding model 'Message'
        db.create_table('djero_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djero.Category'])),
            ('forum', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djero.Forum'])),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(related_name='topic_messages', to=orm['djero.Topic'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal('djero', ['Message'])


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('djero_category')

        # Removing M2M table for field groups on 'Category'
        db.delete_table('djero_category_groups')

        # Deleting model 'Forum'
        db.delete_table('djero_forum')

        # Removing M2M table for field groups on 'Forum'
        db.delete_table('djero_forum_groups')

        # Deleting model 'Moderator'
        db.delete_table('djero_moderator')

        # Deleting model 'Topic'
        db.delete_table('djero_topic')

        # Deleting model 'Message'
        db.delete_table('djero_message')
